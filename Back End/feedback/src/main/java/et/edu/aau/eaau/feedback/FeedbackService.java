...
public class FeedbackService {
    ...
    public boolean addFeedback(FeedbackRequest feedbackRequest) {
        ...
        try {
            responseEntity = restTemplate.getForEntity("http://localhost:8080/api/user/email/" + feedbackRequest.getSentBy(), String.class);
   ...
   public Boolean archiveFeedback(String id){
    ...
    private FeedbackResponse mapToFeedbackResponse(Feedback feedback) {
        ResponseEntity<UserResponse> responseEntity = restTemplate.getForEntity("http://localhost:8080/api/user/email/"+feedback.getSentBy(),UserResponse.class);
